...
export const foodItems = [
  ...
  },
  {
    name: 'French Fries',
    price: '2.50',
    ingredients: 'Eggs, Potatos, oil',
    desc: 'French fries are deep-fried potato strips, enjoyed for their crispy texture and deliciously salty flavor.',
    image: require('../assets/frenchfries.png'),
  },
  {
    name: 'Sushi',
    price: '20.00',
